...
public class LoaderSTL extends Application {



  private static final double MODEL_SCALE_FACTOR = 50;
  ...
  Group buildScene(String mesh) {
    MeshView[] meshViews = loadMeshViews(mesh);
